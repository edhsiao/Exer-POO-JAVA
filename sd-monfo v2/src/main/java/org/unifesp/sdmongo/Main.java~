...
/**
 * Created by Daniel-PC on 19/05/2015.
 */
...
public class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        randomPosts.forEach((e) -> addFavorite(e.getObjectId("_id"), "daniel@email.com"));

        // Recupera os favoritos do usuário de login fornecido e imprime na tela similar a anteriormente
        favorites("daniel@email.com").forEach(e -> System.out.println(e.toJson()));
        ...
        randomPosts.stream().skip(1).forEach(e -> removeFavorite(e.getObjectId("_id"), "daniel@email.com"));
        ...
        randomPosts.forEach(e -> removeFavorite(e.getObjectId("_id"), "daniel@email.com"));
